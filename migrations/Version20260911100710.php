 ...
 */
final class Version20260911100710 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE excursion_id_seq CASCADE');
